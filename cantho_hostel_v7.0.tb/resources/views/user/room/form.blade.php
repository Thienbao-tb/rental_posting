        ...
        <div class="room-left">
            ...
            <div class="row-lists">
                <div class="form-group row-lists-3">
                    ...
                    <select name="qhuyen_id" class="form-control" id="qhuyen_id"
                        ...
                        @foreach($locationsCity ?? [] as $item)
                            <option value="{{ $item->id }}"
                                {{ $item->id == (old('qhuyen_id', $room->qhuyen_id ?? Request::get('qhuyen_id'))) ? "selected" : "" }}>
                                {{ $item->ten }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group row-lists-3">
                    ...
                    <select name="phuongxa_id" class="form-control " id="phuongxa_id"
                        ...
                        @foreach($wards ?? [] as $item)
                            <option value="{{ $item->id }}"
                                {{ $item->id == old('phuongxa_id', $room->phuongxa_id ?? 0) ? "selected" : "" }}>
                                {{ $item->ten }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="row-lists">
                <div class="form-group">
                    ...
                    <input type="text" name="sophong"  value="{{ old('sophong') }}" class="form-control" placeholder="Số nhà"
                        value="{{ $room->sophong ?? '' }}">
                        @error('sophong')
            ...
            <div class="row-lists">
                <div class="form-group w-100">
                    ...
                    <input type="text" name="chitietdiachi" value="{{ old('chitietdiachi') }}" class="form-control" placeholder="Địa chỉ chính xác"
            ...
            <div class="row-lists">
                <div class="form-group row-lists-3">
                    ...
                    @foreach($categories ?? [] as $item)
                        <option value="{{ $item->id }}"
                            {{ $item->id == old('danhmuc_id', $room->danhmuc_id ?? 0) ? "selected" : "" }}>
                            {{ $item->ten }}
                        </option>
                    @endforeach
                    </select>
            ...
            <div class="row-lists">
                <div class="form-group w-100">
                    ...
                    <input type="text" class="form-control" name="ten" value="{{ old('ten') }}" placeholder="Tiêu đề"
                        value="{{ $room->ten ?? ' ' }}">
                    @if ($errors->first('ten'))
            ...
            <div class="row-lists">
                <div class="form-group w-100">
                    ...
                    <textarea name="mota" class="form-control" id="editor" cols="30" rows="3">{{ old('mota', $room->mota ?? '') }}</textarea>
            ...
            <div class="row-lists">
                <div class="form-group">
                    ...
                    <input type="text" class="input-price" name="gia" value="{{ old('gia') }}" class="form-control" placeholder=""
            ...
            <div class="row-lists">
                <div class="form-group">
                    ...
                    <input type="text" name="khuvuc" value="{{ old('khuvuc') }}" class="form-control" placeholder=""
                        value="{{ $room->khuvuc ?? 0 }}">
                        @error('khuvuc')
                            <span class="error">{{ $message }}</span>
                        @enderror

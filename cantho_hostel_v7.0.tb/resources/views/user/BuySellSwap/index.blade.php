...
<div class="container">
    <h1 class="page-title-h1" style="display: flex;justify-content: space-between">Buôn bán trao đồ đồ cũ <a href="{{ route('get_user.pass.create') }}" title="Thêm mới" class="btn btn-sm btn-blue mb_post"
            style="background-color:var(--primary-color)">Thêm tin mới</a></h1>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p>
                            ...
                            <a href="{{ route('get_user.pass.pay', $item->id) }}"> <i class="fa fa-refresh"></i> Thanh
                                toán
                                hoặc gia hạn</a>

...
<div class="mobile_header">
    ...
    <div id="mobile_header_bars" class="mobile_header_bars">
    ...
    <div class="navbar-menu-container">
        ...
        <ul id="menu-main-menu" class="container-menu level-1">
            <li class="navbar_item {{ \Request::route()->getName() == 'get.home' ? 'active' : '' }}"><a
                    href="{{ route('get.home') }}">Trang chủ</a>
            </li>
            ...
            <li class="navbar_item {{ \Request::route()->getName() == 'get.service.price' ? 'active' : '' }}"><a
                href="{{ route('get.service.price') }}">Bảng giá</a>
            </li>
        </ul>
        ...
        <div class="header-default {{ $container ? $container : '' }} container-header">
            <div class="header-area">
                <div class="user-welcome js-reload-html-header">
                    ...
                    <div class="welcome-text">
                        ...
                        <div class="user-history">
                            <div class="user-history-name">
                                ...
                                <span class="text-bold  text-bold_name">{{ Auth::user()->ten ?? "..." }}</span>
                    ...
                    @else
                        <a rel="nofollow" class="btn btn-blue" href="{{ route('get.login') }}"><i style="margin-right:10px" class="fa-solid fa-right-to-bracket"></i>Đăng nhập</a>
                        <a rel="nofollow" class="btn btn-blue" href="{{ route('get.register') }}"><i style="margin-right:10px" class="fa-solid fa-user-plus"></i>Đăng ký</a>
                    @endif
                </div>

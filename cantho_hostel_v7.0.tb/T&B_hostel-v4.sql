...
--
-- Host: localhost:3306
-- Generation Time: Jun 07, 2024 at 04:01 AM
...
(27, 'Mặt bằng', 'mat-bang', NULL, 'Mặt bằng cho thuê', 1, '2024-04-16 17:19:31', '2024-06-06 13:39:49');
...
CREATE TABLE `diachi` (
  ...
  `loai` tinyint NOT NULL DEFAULT '1' COMMENT '1 là quận huyện, 2 là phường xã',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `hinhanh_ct` (
  ...
  `phong_id` bigint NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(204, 'Screenshot 2024-05-25 112657.png', '2024-06-02__screenshot-2024-05-25-112657png.png', 116, '2024-06-02 12:50:09', NULL),
(205, 'hostel_21.jpg', '2024-06-06__hostel-21jpg.jpg', 117, '2024-06-06 15:42:30', NULL),
(206, 'hostel_22.jpg', '2024-06-06__hostel-22jpg.jpg', 117, '2024-06-06 15:42:30', NULL),
(207, 'Cantho_hostel-6.jpg', '2024-06-07__cantho-hostel-6jpg.jpg', 118, '2024-06-06 17:23:21', NULL),
(208, 'Cantho_hostel-7.jpg', '2024-06-07__cantho-hostel-7jpg.jpg', 118, '2024-06-06 17:23:21', NULL),
(209, 'Cantho_hostel-2.jpg', '2024-06-07__cantho-hostel-2jpg.jpg', 119, '2024-06-07 03:27:06', NULL),
(210, 'Cantho_hostel-6.jpg', '2024-06-07__cantho-hostel-6jpg.jpg', 119, '2024-06-07 03:27:06', NULL),
(211, 'Cantho_hostel-7.jpg', '2024-06-07__cantho-hostel-7jpg.jpg', 119, '2024-06-07 03:27:06', NULL),
(212, 'Cantho_hostel-1.png', '2024-06-07__cantho-hostel-1png.png', 120, '2024-06-07 03:29:19', NULL);
...
CREATE TABLE `lichsu_naptien` (
  `id` bigint UNSIGNED NOT NULL,
  `ma` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nguoidung_id` bigint NOT NULL DEFAULT '0',
  `loai` tinyint NOT NULL COMMENT 'phương thức',
...
(128, 'aKHXNmxPXEYy6Li18', 18, 3, 1000000, 0, 1000000, 2, '2024-06-06 17:34:44', '2024-06-06 17:36:26'),
(129, '3xiAKgpDeJW9r9A23', 23, 3, 1000000, 0, 1000000, 1, '2024-06-07 01:49:45', '2024-06-07 01:49:45'),
(130, '4lv7eaRk12eyBNF23', 23, 3, 99999, 0, 99999, 1, '2024-06-07 01:50:13', '2024-06-07 01:50:13'),
(131, 'p51QyJwjJIQWAMC18', 18, 3, 11111, 0, 11111, 1, '2024-06-07 01:50:46', '2024-06-07 01:50:46'),
(132, 'WkkO9pzIGozuFwg18', 18, 3, 1000000, 0, 1000000, 1, '2024-06-07 01:50:56', '2024-06-07 01:50:56'),
(133, 'odhEvrefeY4X0Cy18', 18, 3, 1000000, 0, 1000000, 1, '2024-06-07 01:51:51', '2024-06-07 01:51:51'),
(134, 'xjxW00fn2dJXpeW18', 18, 3, 100000, 0, 100000, 1, '2024-06-07 01:53:09', '2024-06-07 01:53:09'),
(135, 'GM02v3zGhNXjJoz18', 18, 3, 100000, 0, 100000, 1, '2024-06-07 01:54:42', '2024-06-07 01:54:42'),
(136, 'BAXCSYM7LEzmxLI18', 18, 3, 100000, 0, 100000, 1, '2024-06-07 02:05:30', '2024-06-07 02:05:30'),
(137, 'mqi9URXNxzqmibD18', 18, 3, 333333, 0, 333333, 1, '2024-06-07 03:32:25', '2024-06-07 03:32:25');
...
CREATE TABLE `lichsu_thanhtoan` (
  `id` bigint UNSIGNED NOT NULL,
  `nguoidung_id` bigint NOT NULL DEFAULT '0',
  `loai` tinyint NOT NULL DEFAULT '1',
  `phong_id` int NOT NULL DEFAULT '0',
  `dichvu_id` tinyint NOT NULL DEFAULT '0',
  `tien` int NOT NULL DEFAULT '0',
  `trangthai` tinyint NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
(94, 18, 5, 117, 0, 1600000, 2, '2024-06-06 15:42:42', '2024-06-06 15:42:42'),
(95, 18, 3, 118, 0, 600000, 2, '2024-06-06 17:26:52', '2024-06-06 17:26:52'),
(96, 18, 5, 119, 0, 1600000, 2, '2024-06-07 03:27:18', '2024-06-07 03:27:18'),
(97, 18, 5, 120, 0, 1440000, 2, '2024-06-07 03:29:30', '2024-06-07 03:29:30');
...
CREATE TABLE `ma_dien_thoai` (
  `id` bigint UNSIGNED NOT NULL,
  `maxacthuc` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_hoatdong` tinyint NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `nguoidung` (
  ...
  `sodienthoai` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `facebook` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `anhdaidien` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sodukhadung` bigint NOT NULL DEFAULT '0',
...
(18, 'Vũ Tuấn Anh', 'vutuananh01@gmail.com', '0949083414', NULL, '2024-04-17__dsc02763.jpg', 100410471, NULL, '$2a$12$SD17PtZckQEyJcU.LH97WuhGDCUsm8XhGpiR6QhjNmmta2jhsF6.K', NULL, '2024-02-25 13:52:11', '2024-06-06 17:36:26'),
(21, 'Nguyen Bao', 'nguyenbao113@gmail.com', '0977555434', NULL, NULL, 0, NULL, '$2y$10$EaUqoyNF57aKI020tSDmmelUHPMHahyIxak4VZUqN0QKHkjJqOLni', NULL, '2024-04-23 14:53:32', '2024-06-06 17:27:41'),
(22, 'abc', 'abc@gmail.com', '0977778890', NULL, NULL, 0, NULL, '$2y$10$5ju/AWH1ewT7Kb6Do0A0HeUOjvyzkREWO413Hs1.nLy8is9youR9S', NULL, '2024-06-06 15:06:32', '2024-06-06 17:27:49'),
(23, 'Nguyễn Văn A', 'nguyenvana@gmail.com', '09999999999', NULL, '2024-06-07__jcb.png', 0, NULL, '$2y$10$9j.8OyaUsZd.prB4DTop1O2Jb74K83HWYJsKRqPj2/6FVswt/H.fm', NULL, '2024-06-07 01:46:44', '2024-06-07 01:47:18');
...
CREATE TABLE `phong` (
  ...
  `qhuyen_id` bigint NOT NULL DEFAULT '0',
  `phuongxa_id` bigint NOT NULL DEFAULT '0',
  `gia` bigint NOT NULL DEFAULT '0',
  `khoanggia` tinyint NOT NULL DEFAULT '1',
  `khoangkhuvuc` tinyint NOT NULL DEFAULT '1',
  `trangthai` tinyint NOT NULL DEFAULT '1',
  `khuvuc` int NOT NULL DEFAULT '0',
  `sophong` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `chitietdiachi` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `noidung` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `hot` tinyint NOT NULL DEFAULT '0',
  `lydo` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `danhmuc_id` bigint UNSIGNED NOT NULL DEFAULT '0',
  `thoigian_batdau` date DEFAULT NULL,
  `thoigian_ketthuc` date DEFAULT NULL,
  `xacthuc_id` bigint NOT NULL DEFAULT '0',
  `dichvu_hot` tinyint NOT NULL DEFAULT '0',
  `map` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `subject_id` bigint NOT NULL DEFAULT '0',
  `video_link` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'link yt',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(111, 'Mặt tiền Đường Nguyễn Văn Linh vị trí sầm uất phù hợp kinh doanh', 'mat-tien-duong-nguyen-van-linh-vi-tri-sam-uat-phu-hop-kinh-doanh', NULL, '<p>CHO THUÊ NHÀ MẶT TIỀN KINH DOANH GIÁ TỐT ĐƯỜNG NGUYỄN VĂN LINH, CẠNH CHỢ BÀ BỘ - KINH DOANH TỰ DO</p><p>Giá thuê: 8 triệu / tháng - Cọc 2 tháng - hợp đồng từ 1 năm.</p><p>Diện tích: 40m2 ( 1 trệt, 1 lững, 1 wc)</p><p>Tiện ích xung quanh đầy đủ</p><p>Vị trí ngay chợ cực kì sầm uất, an khánh, ninh kiều</p><p>311</p>', 110, 135, 2000000, 3, 7, 3, 89, '22', 'Nguyễn Văn Linh, Phường An Khánh, Quận Ninh Kiều, Cần Thơ', NULL, 0, NULL, 22, '2024-04-04', '2024-04-24', 18, 0, '<iframe src=\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3928.638429576327!2d105.76524067541195!3d10.046665472229249!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31a0880f08006ffb%3A0x9a745510330faf4e!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBL4bu5IHRodeG6rXQgLSBDw7RuZyBuZ2jhu4cgQ-G6p24gVGjGoQ!5e0!3m2!1svi!2s!4v1712163686821!5m2!1svi!2s\" width=\"600\" height=\"450\" style=\"border:0;\" allowfullscreen=\"\" loading=\"lazy\" referrerpolicy=\"no-referrer-when-downgrade\"></iframe>', 0, NULL, '2024-04-03 17:22:06', '2024-06-06 13:16:28'),
(112, 'Mặt tiền Đường Nguyễn Văn Linh vị trí sầm uất phù hợp kinh doanh', 'mat-tien-duong-nguyen-van-linh-vi-tri-sam-uat-phu-hop-kinh-doanh', '2024-04-04__cantho-hostel-7.jpg', '<p>CHO THUÊ NHÀ MẶT TIỀN KINH DOANH GIÁ TỐT ĐƯỜNG NGUYỄN VĂN LINH, CẠNH CHỢ BÀ BỘ - KINH DOANH TỰ DO</p><p>Giá thuê: 8 triệu / tháng - Cọc 2 tháng - hợp đồng từ 1 năm.</p><p>Diện tích: 40m2 ( 1 trệt, 1 lững, 1 wc)</p><p>Tiện ích xung quanh đầy đủ</p><p>Vị trí ngay chợ cực kì sầm uất, an khánh, ninh kiều</p><p>311</p>', 110, 135, 2900000, 3, 9, 3, 120, '23', 'Nguyễn Văn Linh, Phường An Khánh, Quận Ninh Kiều, Cần Thơ', NULL, 0, NULL, 23, NULL, NULL, 18, 0, '<iframe src=\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3928.638429576327!2d105.76524067541195!3d10.046665472229249!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31a0880f08006ffb%3A0x9a745510330faf4e!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBL4bu5IHRodeG6rXQgLSBDw7RuZyBuZ2jhu4cgQ-G6p24gVGjGoQ!5e0!3m2!1svi!2s!4v1712163686821!5m2!1svi!2s\" width=\"600\" height=\"450\" style=\"border:0;\" allowfullscreen=\"\" loading=\"lazy\" referrerpolicy=\"no-referrer-when-downgrade\"></iframe>', 0, NULL, '2024-04-03 17:44:21', '2024-06-07 03:22:15'),
(115, 'NHÀ TRỌ CAO CẤP 30M2, FULL NỘI THẤT, NẰM SAU LƯNG ĐẠI HỌC KỸ THUẬT - CÔNG NGHỆ CẦN THƠ, HẺM Ô TÔ ĐI THOẢI MÁI', 'nha-tro-cao-cap-30m2-full-noi-that-nam-sau-lung-dai-hoc-ky-thuat-cong-nghe-can-tho-hem-o-to-di-thoai-mai', '2024-04-17__cantho-hostel-6.jpg', '<p><strong>Nội dung:</strong><br>NHÀ TRỌ SẠCH SẼ - LUÔN SẠCH SẼ, LUÔN GỌN GÀNG</p><p>Phòng có cửa sổ hành lang</p><p>Phòng mới như hình ảnh, gần&nbsp;Trường Đại học Kỹ thuật – Công nghệ Cần Thơ, cách trường 200m</p><p><strong>Tiện ích:</strong></p><p>- Gần chợ Trần Việt Châu, chợ An Hòa</p><p>- Gần các nhà thuốc: Long Châu, pharmacity</p><p>-&nbsp;Cổng vân tay, camera 24/24,</p><p>- Nhà xe rộng rãi</p><p>- Nhân viên trực tại chổ</p><p>- Nước uống free, khu phơi quần áo, máy giặt tính tiền giá rẻ,</p><p>- Sân thượng</p>', 110, 134, 1000000, 2, 4, 3, 50, 'c1t82', 'C1T82, hẻm 40, đường Võ Trường Toản, phường An Hòa, quận Ninh Kiều, Cần Thơ', NULL, 0, NULL, 21, '2024-04-17', '2024-05-05', 18, 0, '<iframe src=\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3928.6384937437037!2d105.76524067479426!3d10.046660190061154!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31a0880f08006ffb%3A0x9a745510330faf4e!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBL4bu5IHRodeG6rXQgLSBDw7RuZyBuZ2jhu4cgQ-G6p24gVGjGoQ!5e0!3m2!1svi!2s!4v1713280257641!5m2!1svi!2s\" width=\"600\" height=\"450\" style=\"border:0;\" allowfullscreen=\"\" loading=\"lazy\" referrerpolicy=\"no-referrer-when-downgrade\"></iframe>', 0, NULL, '2024-04-16 17:13:44', '2024-06-07 03:22:17'),
(117, 'Cho Thuê Văn Phòng + Mặt bằng + Diện Tích 80m2 ( Có phòng họp , phòng làm việc và phòng chờ .... )', 'cho-thue-van-phong-mat-bang-dien-tich-80m2-co-phong-hop-phong-lam-viec-va-phong-cho', '2024-06-06__hostel-21.jpg', '<p>+ Mặt bằng cho thuê đường xe hơi Tân Sơn Nhì, Quận Tân Bình (rất đông người qua lại tiện kinh doanh online hay mọi ngành nghề hoặc mở văn phòng).</p><p>+ Diện tích: 4 x 20m, có phòng riêng ở lại bên trong, mặt bằng kinh doanh nhỏ bên ngoài, WC riêng.</p><p>+ Gần nhiều siêu thị, chợ, chung cư, gần nhiều tòa cao ốc văn phòng, công ty, nhiều trường đại học, bệnh viện và nhiều địa điểm như: Gần siêu thị Pandora City, ETown Cộng Hòa, chợ Võ Thành Trang (Bà Quẹo), tiện đi lại mọi nơi trong thành phố.</p><p>+ Nhà mặt tiền đường trong khu dân cư sầm uất, rất đông người qua lại, ở và làm việc.</p><p>+ Là nơi lý tưởng để ở và kinh doanh online và các ngành nghề hoặc mở văn phòng.</p><p>+ Có phòng họp riêng và phòng chờ tiếp khách</p><p>- Địa chỉ: &nbsp;hẻm 8, Nguyễn Văn Cừ, An Hòa, Ninh Kiều, Cần Thơ</p><p>Giá giảm chỉ còn: 18 triệu/tháng (giá cũ: 20 triệu/tháng giảm giá và giữ ổn định không tăng giá sau này tạo điều kiện thuận cho khách kinh doanh).</p>', 105, 117, 10000000, 7, 8, 3, 100, '113', '113, Nguyễn Văn Cừ, An Hòa, Ninh Kiều, Cần Thơ', NULL, 0, NULL, 27, '2024-06-07', '2024-06-27', 18, 0, '<iframe src=\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3928.597748979705!2d105.77058187490994!3d10.050013690057927!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31a08805c2a63be9%3A0x7af4c6431108c731!2zQ2jhu6MgQW4gSG_DoA!5e0!3m2!1svi!2s!4v1717688509426!5m2!1svi!2s\" width=\"600\" height=\"450\" style=\"border:0;\" allowfullscreen=\"\" loading=\"lazy\" referrerpolicy=\"no-referrer-when-downgrade\"></iframe>', 0, NULL, '2024-06-06 15:42:30', '2024-06-06 17:12:09'),
(119, 'Mặt bằng Cao Cấp Full Nội Thất, KDC Hồng Phát, gần trường ĐH FPT, ĐH Nam Cần Thơ', 'mat-bang-cao-cap-full-noi-that-kdc-hong-phat-gan-truong-dh-fpt-dh-nam-can-tho', '2024-06-07__img2.jpg', '<p>CHO THUÊ - MINI HOUSE FULL NỘI THẤT CỰC ĐẸP, KDC HỒNG PHÁT, NINH KIỀU CẦN THƠ</p><p>GIÁ: 4,2 Triệu/ tháng</p><p>- Diện tích: 30m2</p><p>- Lộ: oto tới phòng</p><p>- Nội thất: Máy lạnh: Máy giặt, Máy nóng lạnh, Tủ áo, Tủ bếp, Bàn ăn, Giường nệm, màn cửa....</p><p>- Wifi: M.Phí</p><p>- Giờ giấc tự do, cổng rào khóa vân tay...</p>', 110, 111, 3000000, 4, 4, 3, 50, 'C1T2', 'Xuân Thủy, Phường An Bình, Quận Ninh Kiều, Cần Thơ', NULL, 0, NULL, 27, '2024-06-07', '2024-06-27', 18, 5, '<iframe src=\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3928.638429576327!2d105.76524067541195!3d10.046665472229249!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31a0880f08006ffb%3A0x9a745510330faf4e!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBL4bu5IHRodeG6rXQgLSBDw7RuZyBuZ2jhu4cgQ-G6p24gVGjGoQ!5e0!3m2!1svi!2s!4v1712163686821!5m2!1svi!2s\" width=\"600\" height=\"450\" style=\"border:0;\" allowfullscreen=\"\" loading=\"lazy\" referrerpolicy=\"no-referrer-when-downgrade\"></iframe>', 0, NULL, '2024-06-07 03:27:06', '2024-06-07 03:27:39'),
(120, 'Mặt tiền Đường Nguyễn Văn Linh vị trí sầm uất phù hợp kinh doanh', 'mat-tien-duong-nguyen-van-linh-vi-tri-sam-uat-phu-hop-kinh-doanh', '2024-06-07__img2.jpg', '<p>CHO THUÊ NHÀ MẶT TIỀN KINH DOANH GIÁ TỐT ĐƯỜNG NGUYỄN VĂN LINH, CẠNH CHỢ BÀ BỘ - KINH DOANH TỰ DO</p><p>Giá thuê: 8 triệu / tháng - Cọc 2 tháng - hợp đồng từ 1 năm.</p><p>Diện tích: 40m2 ( 1 trệt, 1 lững, 1 wc)</p><p>Tiện ích xung quanh đầy đủ</p><p>Vị trí ngay chợ cực kì sầm uất, an khánh, ninh kiều</p><p>311</p>', 110, 135, 9000000, 6, 10, 3, 200, 'c22', 'Nguyễn Văn Linh, Phường An Khánh, Quận Ninh Kiều, Cần Thơ', NULL, 0, NULL, 23, '2024-06-07', '2024-06-25', 18, 5, '<iframe src=\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3928.638429576327!2d105.76524067541195!3d10.046665472229249!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31a0880f08006ffb%3A0x9a745510330faf4e!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBL4bu5IHRodeG6rXQgLSBDw7RuZyBuZ2jhu4cgQ-G6p24gVGjGoQ!5e0!3m2!1svi!2s!4v1712163686821!5m2!1svi!2s\" width=\"600\" height=\"450\" style=\"border:0;\" allowfullscreen=\"\" loading=\"lazy\" referrerpolicy=\"no-referrer-when-downgrade\"></iframe>', 0, NULL, '2024-06-07 03:29:19', '2024-06-07 03:29:41');

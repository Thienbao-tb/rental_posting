...
Route::group(['namespace' => 'User', 'prefix' => 'user', 'middleware' => 'checkLoginUser'], function () {
    ...
    Route::group(['prefix' => 'pass'], function () {
        Route::get('', 'UserRoomController@indexPass')->name('get_user.pass.index');
        Route::get('create', 'UserRoomController@createPass')->name('get_user.pass.create');
        Route::post('create', 'UserRoomController@storePass');

        Route::get('pay/{id}', 'UserRoomController@payRoomPass')->name('get_user.pass.pay');
        Route::post('pay/{id}', 'UserRoomController@savePayRoomPass');
